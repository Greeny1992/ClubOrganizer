    ...
    const items = userlist!.map((value) => {
      return (
        ...
        <IonCard
          className="userCard"
          key={value.id}
          onClick={() => history.push("/users/edit/" + value.id)}
        >
          <IonCardHeader>
            <IonCardTitle>
            ...
            <IonCardContent>
              <IonGrid>
                <IonRow>
                  {" "}
                  <IonCol>E-Mail:</IonCol> <IonCol>{value.email}</IonCol>
                </IonRow>
                <IonRow>
                  {" "}
                ...
                <IonRow>
                  {" "}
                  <IonCol>Status:</IonCol> <IonCol>{value.active}</IonCol>
                </IonRow>
                <IonRow>
                  {" "}
                  <IonCol>Rolle:</IonCol> <IonCol>{value.role}</IonCol>
                </IonRow>
                <IonRow>
                  {" "}
